...
<style type="text/css">
  ...
  .espacio2{
    ...
    <div class="datos_usuario_titulo">DATOS DE ADMINISTRADOR</div> 
    <hr>
    <?php 
    if(count($administrador) > 0){ 
    ?>

      @foreach($administrador as $eva)

            <div class="section_datos"  style=" float: left;">

            <form method="POST" action="actualizarDatosAdmi" id="actualizar_datos">
              <div class="datos_usuario_titulo">Actualizar datos</div> 
              <hr>

              <div  style="text-align: left;">
                <div class="datos_usuario_titulo">Nombre</div> 
                <div class="datos_usuario">{{$eva->nombre}}</div>
              </div>
                <hr>
              <div  style="text-align: left;">
                <div class="datos_usuario_titulo">Apellido</div> 
                <div class="datos_usuario">{{$eva->apellido}}</div>
              </div>
                <hr>
